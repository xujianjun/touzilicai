...
<div class="row">
	<div class="col-xs-12 col-md-8">{{ partial("widget/slider", ['items':pageData['slider']['school']['items']]) }}</div>
    <div class="col-xs-6 col-md-4">{{ partial("widget/dailyword", ['dailyword':pageData['dailyword']]) }}</div>
</div>
<div class="row">
    ...
    <div class="col-xs-6 col-md-4">{{ partial("widget/hangqing", ['hangqing':pageData['hangqing']]) }}</div>
</div>
<div class="row">
    ...
    <div class="col-xs-6 col-md-4">fund</div>
</div>
<div class="row">
    ...
    <div class="col-xs-6 col-md-4">waihuilv</div>
</div>
<div class="row">
    ...
    <div class="col-xs-6 col-md-4">metal</div>
</div>
<div class="row">
    ...
    <div class="col-xs-6 col-md-4">licaigongju</div>
</div>
